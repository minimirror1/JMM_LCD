; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	D:\stm32_ws\board\JointManipulator_Master\JMM_LCD_V1\JMM_LCD\TouchGFX\generated\fonts\src\FontCache.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__AD4978B8_fontcache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1PM@EAFHIGPN@?$AAd?$AA?3?$AA?2?$AAs?$AAt?$AAm?$AA3?$AA2?$AA_?$AAw?$AAs?$AA?2?$AAb?$AAo?$AAa@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1PM@EAFHIGPN@?$AAd?$AA?3?$AA?2?$AAs?$AAt?$AAm?$AA3?$AA2?$AA_?$AAw?$AAs?$AA?2?$AAb?$AAo?$AAa@
CONST	SEGMENT
??_C@_1PM@EAFHIGPN@?$AAd?$AA?3?$AA?2?$AAs?$AAt?$AAm?$AA3?$AA2?$AA_?$AAw?$AAs?$AA?2?$AAb?$AAo?$AAa@ DB 'd'
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__ehfuncinfo$??1TypedText@touchgfx@@UAE@XZ DD 019930522H
	DD	00H
	DD	00H
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; _this$ = ecx
; File d:\stm32_ws\board\jointmanipulator_master\jmm_lcd_v1\jmm_lcd\touchgfx\generated\fonts\include\fonts\cachedfont.hpp
; Line 79
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __176FB190_cachedfont@hpp
...
; _this$ = ecx
; File d:\stm32_ws\board\jointmanipulator_master\jmm_lcd_v1\jmm_lcd\touchgfx\generated\fonts\src\fontcache.cpp
; Line 419
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
...
$LN3@assertVali:
	mov	esi, esp
	push	174					; 000000aeH
	push	OFFSET ??_C@_1PM@EAFHIGPN@?$AAd?$AA?3?$AA?2?$AAs?$AAt?$AAm?$AA3?$AA2?$AA_?$AAw?$AAs?$AA?2?$AAb?$AAo?$AAa@
...
; Line 66
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??1TypedText@touchgfx@@UAE@XZ
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 204				; 000000ccH
	push	ebx
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$??1TypedText@touchgfx@@UAE@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-220]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??1TypedText@touchgfx@@UAE@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
...
; Line 419
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __CD7AD2A8_font@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 420
	xor	eax, eax
; Line 421
